...
for i in range(len(galaxies)):
    ...
    for j in range(i+1, len(galaxies)):
        galaxy2 = galaxies[j]
        totaldist += abs(galaxy2[0] - galaxy1[0]) + abs(galaxy2[1] - galaxy1[1]) + (countemptyrows(galaxy1[0],galaxy2[0]) + countemptycols(galaxy1[1],galaxy2[1])) * expansionnum
